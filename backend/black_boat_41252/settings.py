"""
Django settings for black_boat_41252 project.
...
ROOT_URLCONF = 'black_boat_41252.urls'
...
WSGI_APPLICATION = 'black_boat_41252.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_boat_41252 API",
    "DESCRIPTION": "API documentation for black_boat_41252 App",
    "VERSION": "v1",
}
